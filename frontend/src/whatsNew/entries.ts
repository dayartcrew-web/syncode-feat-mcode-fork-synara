...
export const WHATS_NEW_ENTRIES: readonly WhatsNewEntry[] = [
    ...
    features: [
      {
        ...
        description:
          "MCode now has first-class Automations for scheduled agent work, with sidebar navigation, list/detail pages, run history, triage actions, and inline editing.",
        details:
      ...
      },
      {
        ...
        details:
          "File attachments now flow through contracts, upload storage, composer paste/drop, provider prompts, Kanban dispatch, recap/bootstrap surfaces, optimistic timeline rendering, caps/rollback, attachment-bearing plan follow-ups, explicit unsupported-file rejection, worktree-backed file preview roots, and blob-based download handling that keeps failed local image downloads inside MCode.",
      },
      {
    ...
    features: [
      {
        ...
        description:
          "MCode now waits for one fresh server snapshot before giving up on a remembered chat route, so app restarts are less likely to dump you onto an empty fallback screen.",
        details:
    ...
    features: [
      {
        ...
        description:
          "MCode now tracks richer local profile stats, including your most worked project, skill and agent usage, active hours, provider/model mix, and prompt activity.",
        details:
          "Profile stats now derive more signal from MCode's local projection database: most-worked project, prompt/thread activity, skill and agent usage, provider/model usage, reasoning patterns, active-hour windows, and token heatmap data are all represented in the profile contract and settings panel.",
      },
      {
    ...
    features: [
      {
        ...
        title: "Your MCode profile has more personality",
        description:
          "Profile settings now include richer identity details, activity stats, and a cleaner editing flow so MCode feels more like your own workspace.",
        details:
      ...
      },
      {
        ...
        details:
          "MCode now tracks thread retention state explicitly, covers soft-delete cleanup behavior with server tests, and keeps deletion/recovery semantics more predictable for early WIP data.",
      },
      {
  ...
  },
  {
    ...
    features: [
      ...
      },
      {
        ...
        description:
          "After provider restarts, reconnects, or quiet ACP sessions, MCode does a better job of reconciling active turns and finishing idle work instead of getting stuck.",
        details:
    ...
    features: [
      {
        ...
        title: "PDFs open safely inside MCode",
        description:
      ...
      },
      {
        ...
        details:
          "MCode now routes file preview through `WorkspaceFilePreview`, `PdfFilePreview`, shared preview headers, markdown/source selection references, workspace file openers, dock pane activation metadata, local preview URL helpers, and tighter file reference context-menu behavior.",
      },
      {
        id: "pi-plugin-routing",
        title: "Pi plugin sessions start in the right place",
        description:
          "Pi-backed plugin flows now route through MCode more reliably, discover model support better, and keep startup prompts attached to the correct provider session.",
        details:
      ...
      },
      {
        ...
        details:
          "MCode now preserves Cursor message identity more reliably, removes the older turn diff tree path, refines changed-file file-list rendering, fixes duplicate plan-mode icons and stale plan sidebar state, and hides inline project actions from the chat header where they created noise.",
      },
      {
  ...
  },
  {
    ...
    features: [
      ...
      },
      {
        ...
        description:
          "There is now a playful soccer-ball physics view for experimenting with motion and interaction inside MCode.",
        details:
  ...
  },
  {
    ...
    features: [
      ...
      },
      {
        ...
        details:
          "MCode now discovers native editor apps and icons, caches icon assets server-side, exposes authenticated icon routes, and tightens macOS/Linux/Windows launcher handling, including Ghostty working-directory behavior and Linux desktop-entry matching.",
      },
      {
        id: "portable-skills",
      ...
      },
      {
        ...
        details:
          "MCode now reconciles legacy migration bookkeeping before running migrations, expands migration coverage, validates workspace real-path containment, and carries terminal environment updates through shared server and web contracts.",
      },
    ],
  },
  {
    ...
    features: [
      ...
      },
      {
        ...
        details:
          "MCode now reads provider credentials and usage data through shared server parsers, normalizes snapshots, stores cached values in SQLite, and renders reusable usage rows, progress tracks, line lists, and settings panels in the web app.",
      },
      {
  ...
  },
  {
    ...
    features: [
      ...
      },
      {
        ...
        details:
          "MCode now caches site favicons server-side, serves authenticated favicon image URLs, recognizes bare domains in composer text, and keeps markdown link text aligned with the same medium-weight chip styling used while composing.",
      },
      {
    ...
    features: [
      {
        ...
        details:
          "Release tooling now validates Mac update artifacts, parses boolean environment flags consistently, and tests the resumable update downloader without the older update-feed cache layer. The README and release docs were refreshed around the current MCode desktop flow too.",
      },
      {
  ...
  },
  {
    ...
    features: [
      ...
      },
      {
        ...
        details:
          "Claude SIGTERM from outside MCode is treated as a benign suspend path, terminal process cleanup has stronger tests, and websocket RPC failure handling is less likely to leave the UI believing a request is still in flight.",
      },
      {
  ...
  },
  {
    ...
    features: [
      ...
      },
      {
        ...
        description:
          "MCode can now generate and cache thread recaps, show current-state context in the chat environment, and reuse provider-backed recap generation without making the transcript harder to follow.",
      },
      {
  ...
  },
  {
    ...
    features: [
      ...
      },
      {
        ...
        description:
          "When Claude reports a missing conversation id, MCode clears the stale resume cursor, recreates the provider session, and retries with transcript context instead of leaving the turn failed.",
      },
      {
        id: "desktop-update-manual-fallback",
        title: "Desktop updates now have a manual escape hatch",
        description:
          "If an in-app install silently fails, MCode restarts the backend, resumes update polling, deduplicates error toasts, and points you at the exact GitHub release page for a manual download.",
      },
      {
      ...
      },
      {
        ...
        description:
          "OpenCode task child sessions and newer shell-step events now flow into MCode's activity timeline, while generic agent task rows keep their useful prompt and result text instead of disappearing or showing wrapper noise.",
      },
      {
    ...
    features: [
      {
        ...
        description:
          "OpenCode startup, model discovery, command discovery, server connection options, and experimental WebSocket mode now flow through the same settings and runtime paths as the rest of MCode.",
      },
      {
      ...
      },
      {
        ...
        description:
          "Fresh repair migrations reconcile older imported migration trackers that skipped MCode's sidechat-source or pinned-thread columns, preventing startup crashes in those upgraded histories.",
      },
      {
  ...
  },
  {
    ...
    features: [
      {
        id: "mcode-home-migration",
        title: "MCode is now the default home",
        description:
          "The app now starts from `~/.mcode`, carries the MCode environment variables through the desktop and server runtime, and safely imports existing `~/.dpcode` or `~/.t3` data on first launch.",
      },
      {
    ...
    features: [
      {
        ...
        description: "MCode now includes Claude Opus 4.8 in the Claude model picker.",
      },
    ],
  },
  {
    ...
    features: [
      ...
      },
      {
        ...
        description:
          "The provider picker no longer treats unknown provider status as usable. Providers stay in a checking state until MCode has confirmed that the local runtime is available and authenticated.",
      },
      {
  ...
  },
  {
    ...
    features: [
      ...
      },
      {
        ...
        description:
          "MCode can now launch and monitor Kilo Code sessions alongside Codex, Claude, Cursor, OpenCode, and Gemini, with health checks, settings, mentions, handoff, and model compatibility wired through the app.",
      },
      {
    ...
    features: [
      {
        ...
        description:
          "MCode now tracks the newer OpenCode SDK session events, keeps titles fresher, and has much deeper coverage around OpenCode startup, output, and recovery flows.",
      },
      {
  ...
  },
  {
    ...
    features: [
      ...
      },
      {
        ...
        description:
          "MCode now serves generated files through a dedicated local-image endpoint with MIME checks, workspace-aware path resolution, and Codex generated_images allowlists for both the normal home and desktop overlay home.",
      },
      {
  ...
  },
  {
    ...
    features: [
      {
        id: "cursor-provider",
        title: "Cursor is now a first-class MCode provider",
        description:
          "Run Cursor CLI sessions directly from MCode with ACP-backed startup, model discovery, existing-chat resume, handoff, and provider health checks alongside Codex and OpenCode.",
      },
      {
  ...
  },
  {
    ...
    features: [
      ...
      },
      {
        ...
        description:
          "The Git actions menu can now commit current work and push it from MCode, keeping the common release and handoff flow closer to the chat.",
      },
      {
  ...
  },
  {
    ...
    features: [
      ...
      },
      {
        ...
        description:
          "The Git menu now includes branch creation with MCode-style names, and PR creation can recover from GitHub duplicate-PR responses by reusing the existing open pull request.",
      },
      {
        id: "legacy-import-recovery",
        title: "Legacy T3 imports heal themselves",
        description:
          "A new migration reconciles older imported T3 Code databases whose migration history skipped MCode schema changes, preventing missing-column crashes after import.",
      },
      {
  ...
  },
  {
    ...
    features: [
      ...
      },
      {
        ...
        description:
          "OpenCode todo events now flow into MCode as active task updates, with a compact banner option for keeping current work visible without taking over the chat.",
      },
      {
      ...
      },
      {
        ...
        description:
          "OpenCode sessions now report context usage more consistently, giving MCode better runtime visibility as conversations grow.",
      },
      {
    ...
    features: [
      {
        ...
        description:
          "Cursor is now available as a provider, with ACP sessions, model discovery, existing chats, handoff, shortcuts, and git text generation wired into MCode.",
      },
      {
      ...
      },
      {
        ...
        description:
          "Toast notifications picked up feature-flag wiring, giving MCode a safer way to roll notification changes forward or back.",
      },
      {
    ...
    features: [
      {
        ...
        description:
          "MCode now handles messy branch switches with clearer recovery actions, recreated stashes, unpublished branch publishing, and stronger checks around conflicts and local work.",
      },
      {
      ...
      },
      {
        ...
        description:
          "The desktop app now has app-level back and forward navigation controls, making it easier to move around MCode without losing your place.",
      },
      {
    ...
    features: [
      {
        ...
        description:
          "GPT-5.5 is now in the model picker with the right default reasoning behavior, so you can move new Codex sessions onto the latest model directly from MCode.",
      },
      {
  ...
  },
  {
    ...
    features: [
      ...
      },
      {
        ...
        description:
          "MCode now shows a proper splash screen while the desktop backend spins up, so launch feels intentional instead of looking briefly stalled.",
      },
      {
    ...
    features: [
      {
        ...
        description:
          "The new theme pack editor lets you tune UI colors directly in MCode, with shared theme tokens keeping the sidebar, composer, transcript, and controls in sync.",
      },
      {
  ...
  },
  {
    ...
    features: [
      ...
      },
      {
        ...
        description:
          "If the updater never answers, MCode now times out and recovers instead of hanging on a permanent Checking status.",
      },
    ],
  },
  {
    ...
    features: [
      ...
      },
      {
        ...
        description:
          "Point MCode at your own Codex, Claude, or Gemini binary when your setup lives outside the default install path.",
      },
      {
