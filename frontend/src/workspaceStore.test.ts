...
describe("workspaceStore", () => {
  ...
  it("keeps chat workspace root while server config is still loading", async () => {
    ...
    useWorkspaceStore.getState().setChatWorkspaceRoot("/Users/tester/Documents/MCode");
    useWorkspaceStore.getState().setChatWorkspaceRoot(undefined);

    expect(useWorkspaceStore.getState().chatWorkspaceRoot).toBe("/Users/tester/Documents/MCode");
  });
