...
const EDITOR_CHAT_PANE_STORAGE_KEY = "mcode.editor.chatPaneWidth";
const EDITOR_SIDEBAR_VISIBLE_STORAGE_KEY = "mcode.editor.sidebarVisible";
const EDITOR_CHAT_PANE_VISIBLE_STORAGE_KEY = "mcode.editor.chatPaneVisible";
...
function shouldShowExplorerEntry(entry: ProjectFileSystemEntry): boolean {
  ...
  if (entry.name.startsWith(".mcode")) {
    return false;
  }
