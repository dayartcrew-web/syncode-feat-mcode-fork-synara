...
import { isTemporaryWorktreeBranch, resolveUniqueMCodeBranchName } from "@t3tools/shared/git";
...
export function resolveDefaultCreateBranchName(
  ...
  return resolveUniqueMCodeBranchName(existingBranchNames, preferredBranch);
}
