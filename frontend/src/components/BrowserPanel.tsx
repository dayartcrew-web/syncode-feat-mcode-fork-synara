...
const BROWSER_WEBVIEW_PARTITION = "persist:mcode-browser";
const BROWSER_PERF_SAMPLE_INTERVAL_MS = 5_000;
const MCODE_BROWSER_LABEL = "MCode browser";
...
function isBrowserPerfLoggingEnabled(): boolean {
  ...
  try {
    return (
      window.localStorage.getItem("mcode:browser-perf") === "1" ||
...
export function BrowserPanel({
  ...
  useEffect(() => {
    ...
    const intervalId = window.setInterval(() => {
      console.info(`[${MCODE_BROWSER_LABEL} panel perf]`, {
        threadId,
